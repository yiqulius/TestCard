package com.yqls.test.testcard;
    ...
    public void onLayoutChildren(final RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (itemCount > CardConfig.DEFAULT_SHOW_ITEM) {
            ...
            for (int position = CardConfig.DEFAULT_SHOW_ITEM; position >= 0; position--) {
                ...
                Log.d(TAG, "onLayoutChildren: " +getWidth()+" "+getHeight()+" "+widthSpace+" "+heightSpace+ getDecoratedMeasuredWidth(view) + getDecoratedMeasuredHeight(view));
                // recyclerview 布局
                ...
                if (position == CardConfig.DEFAULT_SHOW_ITEM) {
                    ...
                    Log.e(TAG, "onLayoutChildren: " + position );
